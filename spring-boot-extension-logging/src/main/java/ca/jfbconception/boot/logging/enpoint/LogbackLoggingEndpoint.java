...
import ca.jfbconception.boot.logging.builder.logback.LogbackLoggerBuilder;
...
public class LogbackLoggingEndpoint extends BaseLoggingEndpoint<Object> implements LoggingEndpoint<Object> {
    ...
    @Override
    public List<ca.jfbconception.boot.logging.Appender> getAppenders() {
        ...
        return appenderName.stream().map(ca.jfbconception.boot.logging.Appender::new).collect(Collectors.toList());
